...
internal sealed class PointerDeviceMatcher
{
    private readonly SupportedPointerDevicesConfig _config;

    public PointerDeviceMatcher(SupportedPointerDevicesConfig config)
    {
        this._config = config ?? throw new ArgumentNullException(nameof(config));
    }

    public PointerDeviceMatch? Match(string devicePath, string vendorId, string productId)
    {
    ...
    private static bool MatchesVendorAndProduct(SupportedPointerDeviceRule rule, string vendorId, string productId)
    {
    ...
    private static bool MatchesPath(SupportedPointerDeviceRule rule, string devicePath)
    {
...
internal sealed class PointerDeviceMatch
{
